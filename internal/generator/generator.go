...
func RenderZigRuntime(api *model.API, cfg Config) []byte {
	...
	body.WriteString("const builtin = @import(\"builtin\");\n")
	...
	if apiUsesStreams(api) {
		...
		body.WriteString("};\n\n")
		body.WriteString("inline fn streamHandleFromUsize(value: usize) std.Io.File.Handle {\n")
		body.WriteString("    return switch (@typeInfo(std.Io.File.Handle)) {\n")
		body.WriteString("        .pointer => @as(std.Io.File.Handle, @ptrFromInt(value)),\n")
		body.WriteString("        else => @as(std.Io.File.Handle, @intCast(value)),\n")
		body.WriteString("    };\n")
		body.WriteString("}\n\n")
		body.WriteString("inline fn streamHandleFromEncoded(value: usize) std.Io.File.Handle {\n")
		body.WriteString("    return streamHandleFromUsize((value >> 2) - 1);\n")
		body.WriteString("}\n\n")
		body.WriteString("inline fn streamFileFromEncoded(value: usize) std.Io.File {\n")
		body.WriteString("    return .{\n")
		body.WriteString("        .handle = streamHandleFromEncoded(value),\n")
		body.WriteString("        .flags = .{ .nonblocking = false },\n")
		body.WriteString("    };\n")
		body.WriteString("}\n\n")
		body.WriteString("pub inline fn streamFile(value: usize) ?std.Io.File {\n")
		body.WriteString("    if (value == 0) return null;\n")
		body.WriteString("    if ((value & stream_handle_mask) != 0) return null;\n")
		body.WriteString("    return streamFileFromEncoded(value);\n")
		body.WriteString("}\n\n")
		...
		body.WriteString("    return @ptrFromInt(value & ~stream_handle_mask);\n")
		body.WriteString("}\n\n")
		body.WriteString("const stream_is_windows = builtin.os.tag == .windows;\n\n")
		body.WriteString("inline fn streamReadCompat(handle: std.Io.File.Handle, buffer: []u8) anyerror!usize {\n")
		body.WriteString("    if (stream_is_windows) {\n")
		body.WriteString("        const io = std.Io.Threaded.global_single_threaded.io();\n")
		body.WriteString("        const file: std.Io.File = .{\n")
		body.WriteString("            .handle = handle,\n")
		body.WriteString("            .flags = .{ .nonblocking = false },\n")
		body.WriteString("        };\n")
		body.WriteString("        return file.readStreaming(io, &.{buffer}) catch |err| switch (err) {\n")
		body.WriteString("            error.EndOfStream => 0,\n")
		body.WriteString("            else => err,\n")
		body.WriteString("        };\n")
		body.WriteString("    }\n")
		body.WriteString("    return std.posix.read(handle, buffer);\n")
		body.WriteString("}\n\n")
		body.WriteString("inline fn streamWriteCompat(handle: std.Io.File.Handle, buffer: []const u8) anyerror!usize {\n")
		body.WriteString("    if (stream_is_windows) {\n")
		body.WriteString("        const io = std.Io.Threaded.global_single_threaded.io();\n")
		body.WriteString("        const file: std.Io.File = .{\n")
		body.WriteString("            .handle = handle,\n")
		body.WriteString("            .flags = .{ .nonblocking = false },\n")
		body.WriteString("        };\n")
		body.WriteString("        return file.writeStreaming(io, &.{}, &.{buffer}, 1);\n")
		body.WriteString("    }\n")
		body.WriteString("    while (true) {\n")
		body.WriteString("        const rc = std.posix.system.write(handle, buffer.ptr, buffer.len);\n")
		body.WriteString("        switch (std.posix.errno(rc)) {\n")
		body.WriteString("            .SUCCESS => return @intCast(rc),\n")
		body.WriteString("            .INTR => continue,\n")
		body.WriteString("            .AGAIN => return error.WouldBlock,\n")
		body.WriteString("            .ACCES => return error.AccessDenied,\n")
		body.WriteString("            .PERM => return error.PermissionDenied,\n")
		body.WriteString("            .PIPE => return error.BrokenPipe,\n")
		body.WriteString("            .NOSPC => return error.NoSpaceLeft,\n")
		body.WriteString("            .DQUOT => return error.DiskQuota,\n")
		body.WriteString("            .IO => return error.InputOutput,\n")
		body.WriteString("            .NOBUFS, .NOMEM => return error.SystemResources,\n")
		body.WriteString("            .FBIG => return error.FileTooBig,\n")
		body.WriteString("            .BUSY => return error.DeviceBusy,\n")
		body.WriteString("            .NXIO => return error.NoDevice,\n")
		body.WriteString("            .TXTBSY => return error.FileBusy,\n")
		body.WriteString("            .BADF => return error.Unexpected,\n")
		body.WriteString("            else => |err| return std.posix.unexpectedErrno(err),\n")
		body.WriteString("        }\n")
		body.WriteString("    }\n")
		body.WriteString("}\n\n")
		...
		body.WriteString("    const tag = reader & stream_handle_mask;\n")
		body.WriteString("    if (tag == stream_handle_direct_reader) {\n")
		...
		body.WriteString("    }\n")
		body.WriteString("    if (tag != 0) return error.StreamReadFailed;\n")
		body.WriteString("    const n = streamReadCompat(streamHandleFromEncoded(reader), buffer) catch { return error.StreamReadFailed; };\n")
		...
		body.WriteString("    const tag = writer & stream_handle_mask;\n")
		body.WriteString("    if (tag == stream_handle_direct_writer) {\n")
		...
		body.WriteString("    }\n")
		body.WriteString("    if (tag != 0) return error.StreamWriteFailed;\n")
		body.WriteString("    return streamWriteCompat(streamHandleFromEncoded(writer), buffer) catch { return error.StreamWriteFailed; };\n")
		body.WriteString("}\n\n")
	}
...
func renderStreamRuntime() string {
	...
	b.WriteString("\tfileHandle uintptr\n")
	...
	b.WriteString("func _go2zigEncodeFileHandle(handle uintptr) (uintptr, bool) {\n")
	b.WriteString("\tconst maxEncodedFileHandle = (^uintptr(0) >> 2) - 1\n")
	b.WriteString("\tif handle > maxEncodedFileHandle {\n\t\treturn 0, false\n\t}\n")
	b.WriteString("\treturn (handle + 1) << 2, true\n}\n\n")
	b.WriteString("func _go2zigNewFileStreamState(file *os.File, owned io.Closer, upstream io.Closer) (*_go2zigStreamState, error) {\n")
	b.WriteString("\tif file == nil {\n\t\treturn &_go2zigStreamState{owned: owned, upstream: upstream}, nil\n\t}\n")
	b.WriteString("\tfileHandle, ok := _go2zigEncodeFileHandle(file.Fd())\n")
	b.WriteString("\tif !ok {\n\t\treturn nil, fmt.Errorf(\"go2zig: file handle %d cannot be encoded\", file.Fd())\n\t}\n")
	b.WriteString("\treturn &_go2zigStreamState{file: file, fileHandle: fileHandle, owned: owned, upstream: upstream}, nil\n}\n\n")
	...
	b.WriteString("\tif s != nil && s.fileHandle != 0 {\n\t\treturn s.fileHandle\n\t}\n")
	...
	b.WriteString("\t\tstate, err := _go2zigNewFileStreamState(file, upstream, nil)\n")
	b.WriteString("\t\tif err != nil {\n\t\t\treturn GoReader{}, err\n\t\t}\n")
	b.WriteString("\t\treturn GoReader{state: state}, nil\n\t}\n")
	b.WriteString("\tpr, pw, err := os.Pipe()\n\tif err != nil {\n\t\treturn GoReader{}, err\n\t}\n")
	b.WriteString("\tstate, err := _go2zigNewFileStreamState(pr, pr, upstream)\n")
	b.WriteString("\tif err != nil {\n\t\t_ = pr.Close()\n\t\t_ = pw.Close()\n\t\treturn GoReader{}, err\n\t}\n")
	...
	b.WriteString("\t\treturn GoWriter{state: state}, nil\n\t}\n")
	b.WriteString("\tpr, pw, err := os.Pipe()\n\tif err != nil {\n\t\treturn GoWriter{}, err\n\t}\n")
	b.WriteString("\tstate, err := _go2zigNewFileStreamState(pw, pw, upstream)\n")
	b.WriteString("\tif err != nil {\n\t\t_ = pr.Close()\n\t\t_ = pw.Close()\n\t\treturn GoWriter{}, err\n\t}\n")
	b.WriteString("\tstate.copyWG.Add(1)\n")
	b.WriteString("\tgo func() {\n")
