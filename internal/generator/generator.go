...
func RenderZigRuntime(api *model.API, cfg Config) []byte {
	...
	if apiUsesStreams(api) {
		...
		body.WriteString("    };\n")
		body.WriteString("}\n\n")
		body.WriteString("inline fn streamHandleFromEncoded(value: usize) std.fs.File.Handle {\n")
		...
		body.WriteString("    const file: std.fs.File = .{ .handle = streamHandleFromEncoded(reader) };\n")
		...
		body.WriteString("    const file: std.fs.File = .{ .handle = streamHandleFromEncoded(writer) };\n")
